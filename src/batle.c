...
//	    n++;
      ...
      } else if ((actual == 10) && (flag == ((p1.gkick.hit - 1) * p1.gkick.spd)) &&
      ...
      } else if ((actual == 13) && (flag == ((p1.gpunch.hit - 1) * p1.gpunch.spd)) &&
      ...
      } else if ((actual2 == 10) && (flag2 == ((p2.gkick.hit - 1) * p2.gkick.spd)) &&
      ...
      } else if ((actual2 == 13) && (flag2 == ((p2.gpunch.hit - 1) * p2.gpunch.spd)) &&
