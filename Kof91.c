...
END_OF_FUNCTION(increment_frame_count)
...
//	   }
    ...
    allegro_message(
            ...
            "KOF91 is FREEWARE and CANNOT BE SOLD", title, open1, open2, open3, open4, open5);
...
/* Intro *********************************/
    ...
    while (cx) {
        ...
        masked_blit(Carton_KO, virtscreen, 0, 0, (320 - Carton_KO->w) / 2, (3 * 200 / 4) - (Carton_KO->h / 2),
                    Carton_KO->w, Carton_KO->h);

        masked_blit(Carton_WN, virtscreen, 0, 0, (320 - Carton_KO->w) / 2 + 12, (3 * 200 / 4) - (Carton_KO->h / 2) + cy,
    ...
    if (gmode) {
        ...
        while (cx) {
            ...
            masked_blit(Carton_WN, virtscreen, 0, 0, (320 - Carton_KO->w) / 2 + 12,
                        (3 * 200 / 4) - (Carton_KO->h / 2) + cy, Carton_WN->w, Carton_WN->h);
...
/******* GET CHARACTER 2 INFO *********************/
    ...
    if (p2.firebx.flg) {
        ...
        p2.firebx.dmg = get_config_int(sectn, "firebx_dmg", p2.firebx.spec ? 5 : 3);
        ...
        while (n > 0) {
            ...
            while (deb) {
                ...
                if ((deb > 50) && (deb < 150)) {
                    ...
                    else if (deb > 124) angle = (25 - (deb - 125)) * (Carton_R1->w / 25);
                    else angle = Carton_R1->w;

                    switch (round) {
                        case 1 :
                            stretch_sprite(virtscreen, Carton_R1, (320 - angle) / 2, (200 - Carton_R1->h) / 2, angle,
                                           Carton_R1->h);
                            break;

                        case 2 :
                            stretch_sprite(virtscreen, Carton_R2, (320 - angle) / 2, (200 - Carton_R2->h) / 2, angle,
                                           Carton_R2->h);
                            break;

                        case 3 :
                            stretch_sprite(virtscreen, Carton_R3, (320 - angle) / 2, (200 - Carton_R3->h) / 2, angle,
                                           Carton_R3->h);
                            break;
                    ...
                    masked_blit(Carton_FT, virtscreen, 0, 0, (320 - Carton_FT->w) / 2, (200 - Carton_FT->h) / 2,
            ...
            if (retrace_count > 0);
                ...
                switch (actual2) {
                    ...
                    case 19:
                        ...
                        break;
                    case 20:
                        GKO2((hflag2 / 7), (spr2x - (p2.ko.w - p2.width)), spr2y, (p2.ko.w - p2.width));
                        break;
                }
                ...
                if (ak) {
                    ...
                    switch (actual) {
                        ...
                        case 4:
                        case 5:
                            if (spr1y < (sol1 - 50)) GJump(3, spr1x, spr1y);
                ...
                if (ak2) {
                    ...
                    switch (actual2) {
                        ...
                        case 4:
                        case 5:
                            if (spr2y < (sol2 - 50)) GJump2(3, spr2x, spr2y);
                        ...
                        case 30:
                            GFireB2((flag2 / p2.fireb.spd), spr2x - (p2.fireb.w - p2.width), spr2y);
                            break;
                        case 40:
                            GRush2((flag2 / p2.rush.spd), spr2x - (p2.rush.w - p2.width), spr2y);
                            break;
                        case 50:
                            GSMove2((flag2 / p2.smove.spd), spr2x - (p2.smove.w - p2.width), spr2y);
                            break;

                        case 31:
                            GFireBX2((flag2 / p2.firebx.spd), spr2x - (p2.firebx.w - p2.width), spr2y);
                            break;
                        case 41:
                            GRushX2((flag2 / p2.rushx.spd), spr2x - (p2.rushx.w - p2.width), spr2y);
                            break;
                        case 51:
                            GSMoveX2((flag2 / p2.smovex.spd), spr2x - (p2.smovex.w - p2.width), spr2y);
                            break;

                        case 6:
                            GPunch2((flag2 / p2.spunch.spd), spr2x - (p2.spunch.w - p2.width), spr2y);
                            p2.limdefx = p2.spunch.defx;
                            p2.limdefy = p2.spunch.defy;
                            break;
                        case 61:
                            GWPunch2((flag2 / p2.wpunch.spd), spr2x - (p2.wpunch.w - p2.width), spr2y);
                            p2.limdefx = p2.wpunch.defx;
                            p2.limdefy = p2.wpunch.defy;
                            break;

                        case 7:
                            GKick2((flag2 / p2.skick.spd), spr2x - (p2.skick.w - p2.width), spr2y, 1);
                            p2.limdefx = p2.skick.defx;
                            p2.limdefy = p2.skick.defy;
                            break;
                        case 71:
                            GWKick2((flag2 / p2.wkick.spd), spr2x - (p2.wkick.w - p2.width), spr2y);
                            p2.limdefx = p2.wkick.defx;
                            p2.limdefy = p2.wkick.defy;
                            break;

                        case 10:
                            GGKick2((flag2 / p2.gkick.spd), spr2x - (p2.gkick.w - p2.width), spr2y);
                            p2.limdefx = p2.gkick.defx;
                            p2.limdefy = p2.gkick.defy;
                            break;
                        case 13:
                            GGPunch2((flag2 / p2.gpunch.spd), spr2x - (p2.gpunch.w - p2.width), spr2y);
...
/***** PLAYER1 **********/
...

            {
                ...
                if (sens1) {
                    ...
                    else if (spr1y < (jump_how1 + 17)) spr1y += 2;
                    else
                        spr1y += 3;
            ...
            } else if (actual == 4)    // JUMP BACKWARD
            {
                ...
                if (sens1) {
                    if (spr1y < (jump_how1 + 4)) spr1y++;
                    else if (spr1y < (jump_how1 + 30)) spr1y += 2;
                    else
                        spr1y += 3;
            ...
            } else if ((actual == 30) && (limp1 > 0)) // FIREB
            {
                ...
                else if (apch2 == (p2.apunch.spd * p2.apunch.hit) - 3) Hurt(2);
...
/******** PLAYER 2 ***********/
...

            {
                ...
                if (sens2) {
                    ...
                    else if (spr2y < (jump_how2 + 17)) spr2y += 2;
                    else
                        spr2y += 3;
            ...
            } else if (actual2 == 4)    // JUMP FORWARD
            {
                ...
                if (sens2) {
                    if (spr2y < (jump_how2 + 4)) spr2y++;
                    else if (spr2y < (jump_how2 + 30)) spr2y += 2;
                    else
                        spr2y += 3;
            ...
            } else if (actual2 == 5)    // JUMP BACKWARD
            {
                ...
                else if (apch == (p1.apunch.hit * p1.apunch.spd) - 3) Hurt(2);
                ...
                if (hflag2 < 7)
                    ...
                    if ((spr2x < (limd + cx)) && (spr1x > (limg + cx))) {
                        ...
                        else if (cx < (bkgdlim + 320 - zoomwidth)) { cx++; }
...
/************** UPDATE FIREBALLS **************/
            ...
            if (fball1) {
                ...
                if (fball2) {
                    ...
                    } else if (fb1x > (cx + zoomwidth)) fball1 = 0;
                }
            ...
            if (fballx1) {
                ...
                if (fball2) {
                    ...
                    } else if (fb1x > (cx + zoomwidth)) fballx1 = 0;
                }
...

            {
                ...
                if (p1.fireb.flg) {
                    if (check_kstatus1(p1.fireb.seq[0]) && !p1.fireb.succ) {
                        ...
                        if ((last_status1 == p1.fireb.seq[p1.fireb.nb]) ||
                            ...
                            } else if (!check_kstatus1(last_status1)) p1.fireb.succ = 0;
                ...
                if (p1.rush.flg) {
                    if (check_kstatus1(p1.rush.seq[0]) && !p1.rush.succ) {
                        ...
                        if ((last_status1 == p1.rush.seq[p1.rush.nb]) ||
                            ...
                            } else if (!check_kstatus1(last_status1)) p1.rush.succ = 0;
                        } else p1.rush.succ = 0;
                    } else p1.rush.succ = 0;
                } else p1.rush.succ = 0;
                ...
                if (p1.smove.flg) {
                    if (check_kstatus1(p1.smove.seq[0]) && !p1.smove.succ) {
                        ...
                        if ((last_status1 == p1.smove.seq[p1.smove.nb]) ||
                            ...
                            } else if (!check_kstatus1(last_status1)) p1.smove.succ = 0;
...
// NOW FOR SPECIALS
                ...
                if (p1.firebx.flg && p1.firebx.sflg) {
                    if (check_kstatus1(p1.firebx.seq[0]) && !p1.firebx.succ) {
                        ...
                        if ((last_status1 == p1.firebx.seq[p1.firebx.nb]) ||
                            ...
                            } else if (!check_kstatus1(last_status1)) p1.firebx.succ = 0;
                ...
                if (p1.rushx.flg && p1.rushx.sflg) {
                    if (check_kstatus1(p1.rushx.seq[0]) && !p1.rushx.succ) {
                        ...
                        if ((last_status1 == p1.rushx.seq[p1.rushx.nb]) ||
                            ...
                            } else if (!check_kstatus1(last_status1)) p1.rushx.succ = 0;
                ...
                if (p1.smovex.flg && p1.smovex.sflg) {
                    if (check_kstatus1(p1.smovex.seq[0]) && !p1.smovex.succ) {
                        ...
                        if ((last_status1 == p1.smovex.seq[p1.smovex.nb]) ||
                            ...
                            } else if (!check_kstatus1(last_status1)) p1.smovex.succ = 0;
            ...
            if (((actual2 < 3) || (actual2 > 100)) && !gmode) {
                ...
                if ((actual2 == 2) && (limp2 > 0)) {
                    if ((key[p2_wkick]) || (key[p2_skick])) {
                        ...
                        fx = 1;
                    } else if ((key[p2_wpunch]) || (key[p2_spunch])) {
                ...
                if (p2.fireb.flg) {
                    if (check_kstatus2(p2.fireb.seq[0]) && !p2.fireb.succ) {
                        ...
                        if ((last_status2 == p2.fireb.seq[p2.fireb.nb]) ||
                            ...
                            } else if (!check_kstatus2(last_status2)) p2.fireb.succ = 0;
                ...
                if (p2.rush.flg) {
                    if (check_kstatus2(p2.rush.seq[0]) && !p2.rush.succ) {
                        ...
                        if ((last_status2 == p2.rush.seq[p2.rush.nb]) ||
                            ...
                            } else if (!check_kstatus2(last_status2)) p2.rush.succ = 0;
                        } else p2.rush.succ = 0;
                    } else p2.rush.succ = 0;
                } else p2.rush.succ = 0;
                ...
                if (p2.smove.flg) {
                    if (check_kstatus2(p2.smove.seq[0]) && !p2.smove.succ) {
                        ...
                        if ((last_status2 == p2.smove.seq[p2.smove.nb]) ||
                            ...
                            } else if (!check_kstatus2(last_status2)) p2.smove.succ = 0;
...
// NOW FOR SPECIALS
                ...
                if (p2.firebx.flg && p2.firebx.sflg) {
                    if (check_kstatus2(p2.firebx.seq[0]) && !p2.firebx.succ) {
                        ...
                        if ((last_status2 == p2.firebx.seq[p2.firebx.nb]) ||
                            ...
                            } else if (!check_kstatus2(last_status2)) p2.firebx.succ = 0;
                ...
                if (p2.rushx.flg && p2.rushx.sflg) {
                    if (check_kstatus2(p2.rushx.seq[0]) && !p2.rushx.succ) {
                        ...
                        if ((last_status2 == p2.rushx.seq[p2.rushx.nb]) ||
                            ...
                            } else if (!check_kstatus2(last_status2)) p2.rushx.succ = 0;
                ...
                if (p2.smovex.flg && p2.smovex.sflg) {
                    if (check_kstatus2(p2.smovex.seq[0]) && !p2.smovex.succ) {
                        ...
                        if ((last_status2 == p2.smovex.seq[p2.smovex.nb]) ||
                            ...
                            } else if (!check_kstatus2(last_status2)) p2.smovex.succ = 0;
...
// UPDATE AIR-PUNCH ***********/
            ...
            if ((actual2 > 2) && (actual2 < 6) && (ak2 == 0)) {
                if (apch2 && limak2) {
                    ...
                    if (limak2)
                        if ((key[p2_spunch]) || (key[p2_wpunch])) {
                            apch2 = 1;
                            Paf(1);
                            fx = 1;
                        }
            ...
            if ((actual == 6) && (flag == ((p1.spunch.hit - 1) * p1.spunch.spd)))// PUNCH
            {
                if (((spr1x + p1.spunch.offx) > (spr2x + p2.width - p2.limdefx))
                    ...
                    if (spr2y < (sol2 - 5)) {
                        ...
                        p1.wimpact_ct = 10;
                    } else if (key[p2_down] || com_gblock) {
                        if (key[p2_right] || com_gblock) {
                            p1.bimpact_ct = 10;
                            actual2 = 18;
                        } else {
                ...
                if (((spr1x + p1.akick.offx) > (spr2x + p2.width - p2.limdefx))
                    ...
                    if (spr2y < (sol2 - 5)) {
                        ...
                        if (key[p2_right] || com_block) {
                            ...
                            p1.wimpact_ct = 10;
                            actual2 = 9; /*hitfram1 = (p1.akick.hit-1)*p1.akick.spd ;*/ }
                    }
                ...
                if (((spr1x + p1.apunch.offx) > (spr2x + p2.width - p2.limdefx))
                    ...
                    if (spr2y < (sol2 - 5)) {
                        ...
                        if (key[p2_right] || com_block) {
                            ...
                            p1.wimpact_ct = 10;
                            actual2 = 9;/*hitfram1 = (p1.apunch.hit-1)*p1.apunch.spd ; */}
                    }
                ...
                if (((spr2x - (p2.akick.offx - p2.width)) < (spr1x + p1.limdefx))
                    ...
                    if (spr1y < (sol1 - 5)) {
                        ...
                        if (P1_LT) {
                            ...
                            p2.wimpact_ct = 10;
                            actual = 9; /*hitfram2 = (p2.akick.hit-1)*p2.akick.spd ;*/ }
                ...
                if (((spr2x - (p2.apunch.offx - p2.width)) < (spr1x + p1.limdefx))
                    ...
                    if (spr1y < (sol1 - 5)) {
                        ...
                        if (P1_LT) {
                            ...
                            p2.wimpact_ct = 10;
                            actual = 9; /*hitfram2 = (p2.apunch.hit-1)*p2.apunch.spd ; */}
                    }
            ...
            if ((life1 <= 0) || (life2 <= 0)) {
                ...
                if (life1 <= 0) {
                    ...
                    if (t_clock <= 1) {
                        ...
                        masked_blit(Carton_KO, virtscreen, 0, 0, (320 - Carton_KO->w) / 2, (200 - Carton_KO->h) / 2,
                                    Carton_KO->w, Carton_KO->h);
                    ...
                    for (i = Carton_WN->w; i > (Carton_WN->w / 3); i--) {
                        ...
                        stretch_sprite(virtscreen, Carton_WN, 290 - i, 30, i, i / angle);
                    ...
                    for (i = Carton_WN->w; i > (Carton_WN->w / 3); i--) {
                        ...
                        stretch_sprite(virtscreen, Carton_WN, 30, 30, i, i / angle);
...
void GKO(int gueu, int x, int y) {
    ...
    switch (gueu) {
        ...
        case 1 :
            draw_rle_sprite(zoomscreen, Player1.KO[1], x, y);
            break;
        case 2 :
            draw_rle_sprite(zoomscreen, Player1.KO[2], x, y);
            break;
        case 3 :
            draw_rle_sprite(zoomscreen, Player1.KO[3], x, y);
            break;
        case 4 :
            draw_rle_sprite(zoomscreen, Player1.KO[4], x, y);
            break;
        case 5 :
        case 6 :
        default:
            draw_rle_sprite(zoomscreen, Player1.Single[1], (x + 15), y);
            break;
    }
}
...
void GDead(int gueu, int x, int y) {
    ...
    switch (gueu) {
        ...
        case 7 :
        default:
            draw_rle_sprite(zoomscreen, Player1.KO[5], x, y);
            break;
    }
}
...
void GKO2(int gueu, int x, int y, int z) {
    ...
    switch (gueu) {
        case 1 :
            draw_rle_sprite(zoomscreen, Player2.KO[1], x, y);
            break;
        case 2 :
            draw_rle_sprite(zoomscreen, Player2.KO[2], x, y);
            break;
        case 3 :
            draw_rle_sprite(zoomscreen, Player2.KO[3], x, y);
            break;
        case 4 :
            draw_rle_sprite(zoomscreen, Player2.KO[4], x, y);
            break;
        case 5 :
        case 6 :
        default:
            draw_rle_sprite(zoomscreen, Player2.Single[1], (x + z - 25), y);
            break;
...
void GDead2(int gueu, int x, int y) {
    ...
    switch (gueu) {
        ...
        case 7 :
        default:
            draw_rle_sprite(zoomscreen, Player2.KO[5], x, y);
            break;
    }
}
...
char check_kstatus1(char ctrl_key) {
    ...
    switch (ctrl_key) {
        ...
        default:
            allegro_message("problem in check_kstatus1() : %c", ctrl_key);
            exit(0);
            break;
...
char check_kstatus2(char ctrl_key) {
    ...
    switch (ctrl_key) {
        case 0 :
            if (!key[p2_up] && !key[p2_down] && !key[p2_left] && !key[p2_right]
        ...
        case 1 :
            if (key[p2_up] && !key[p2_down] && !key[p2_left]
                && !key[p2_right]
                && !key[p2_wpunch] && !key[p2_spunch]
                && !key[p2_wkick] && !key[p2_skick])
        ...
        case 2 :
            if (key[p2_down] && !key[p2_up] && !key[p2_left]
                && !key[p2_right]
                && !key[p2_wpunch] && !key[p2_spunch]
                && !key[p2_wkick] && !key[p2_skick])
        ...
        case 3 :
            if (!key[p2_left] && !key[p2_up] && !key[p2_down]
                && key[p2_right]
                && !key[p2_wpunch] && !key[p2_spunch]
                && !key[p2_wkick] && !key[p2_skick])
        ...
        case 4 :
            if (!key[p2_right] && !key[p2_up] && !key[p2_down]
                && key[p2_left]
                && !key[p2_wpunch] && !key[p2_spunch]
                && !key[p2_wkick] && !key[p2_skick])
        ...
        case 5 :
            if (key[p2_down] && !key[p2_up] && key[p2_right]
                && !key[p2_left]
                && !key[p2_wpunch] && !key[p2_spunch]
                && !key[p2_wkick] && !key[p2_skick])
        ...
        case 9 :
            if ((key[p2_wpunch] || key[p2_spunch]) && (!key[p2_wkick]
                                                       && !key[p2_skick]))
        ...
        default:
            allegro_message("problem in check_kstatus2() : %c", ctrl_key);
            exit(0);
            break;
...
int scan_files(char *name, int attrib, char what, char *ext) {
    ...
    if (d) {
        while ((dir = readdir(d)) != NULL) {
            ...
            } else if (what == 1 && ends_with(buf, ext)) {
                ustrncpy(bkgdname[c], buf + 11, 30);
                c++;
            } else if (what == 2 && ends_with(buf, ext)) {
